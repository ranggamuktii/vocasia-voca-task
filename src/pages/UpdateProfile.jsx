...
const UpdateProfile = () => {
  return (
    <div className="bg-white w-full sm:max-w-sm md:max-w-md px-6 py-8 sm:px-6 sm:py-8 rounded-[30px] shadow-md space-y-5">
      <div className="flex font-medium cursor-pointer hover:scale-102 transition duration-500">
